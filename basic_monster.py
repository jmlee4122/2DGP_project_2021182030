...
class Death:
    ...
    def do(self):
        ...
        self.basic.frame = (self.basic.frame + FRAMES_PER_ACTION_DEATH * ACTION_PER_TIME_DEATH * dt) % 10
...
class Idle:
    ...
    def do(self):
        dt = min(game_framework.frame_time, 0.06)
        self.basic.frame = (self.basic.frame + FRAMES_PER_ACTION_IDLE * ACTION_PER_TIME_IDLE * dt) % 5
        #self.basic.frame = 0
